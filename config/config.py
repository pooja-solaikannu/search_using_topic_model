TRAIN_DATA = "../data/flowers_desc_dataset.xlsx"
DOC_TOPIC_DIST = "../data/doc_topic_dist.csv"
LDA_MODEL = "../data/models/lda.pkl"
VECTORIZER_MODEL = "../data/models/vectorizer.pkl"
